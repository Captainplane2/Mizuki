...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "Captainplane东方魔法工作台", // 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Captainplane2?tab=repositories",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/291918485",
					external: true,
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	//"https://www.bilibili.uno/api?server=tencent&type=playlist&id=9656298176&auth=:auth&r=:r", // Meting API 地址
	id: "17718017182", // 歌单ID 14164869977
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "备案号：湘ICP备2026003341号", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Captainplane&Mizuki Website!", // 欢迎词
		touch: ["你要干嘛！", "别碰我!", "变态!", "Why bully me!"], // 触摸提示
		home: "点击返回首页!", // 首页提示
		skin: ["想看我的新衣服吗?", "看上去很不错~"], // 换装提示
